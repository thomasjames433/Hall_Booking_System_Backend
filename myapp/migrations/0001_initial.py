# Generated by Django 5.0.7 on 2024-12-15 17:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_status', models.CharField(choices=[('booked', 'Booked'), ('available', 'Available'), ('pending', 'Pending'), ('rejected', 'Rejected')], max_length=15)),
                ('timeofreq', models.DateTimeField(blank=True, default=datetime.datetime.now, null=True)),
